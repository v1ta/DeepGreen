...
public class Board implements Cloneable, Serializable {
  ...
  public boolean isEmpty(int i, int j) {
    return this.cells[i][j] == null || this.cells[i][j] instanceof Enpassant;
  }
  ...
  public boolean isEnpassant(int i, int j) {
    return this.cells[i][j] instanceof Enpassant;
  }
  ...
  public void updatePiece(Piece piece, String newPiece) {
    ...
    switch (choice) {
      case 'q':
        ...
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            = new Queen(piece.getOwner(), piece.getPos());
        break;
      case 'b':
        this.cells[piece.getPos().getI()][piece.getPos().getJ()].kill();
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            = new Bishop(piece.getOwner(), piece.getPos());
        break;
      case 'n':
        this.cells[piece.getPos().getI()][piece.getPos().getJ()].kill();
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            = new Knight(piece.getOwner(), piece.getPos());
        break;
      case 'r':
        this.cells[piece.getPos().getI()][piece.getPos().getJ()].kill();
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            = new Rook(piece.getOwner(), piece.getPos());
        break;
      default:

    }
    if (piece.getOwner().charAt(0) == 'W') {
      try {
        Class<drawable> res = R.drawable.class;
        Field field = null;
        ...
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            .pieceMap = new PieceView(this.container.getContext(),
            this.cells[piece.getPos().getI()][piece.getPos().getJ()]);
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            .pieceMap.setImageResource(drawableId);
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            .pieceMap.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            .pieceMap.getLayoutParams().height = sDim / 8;
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            .pieceMap.getLayoutParams().width = sDim / 8;
        this.cells[piece.getPos().getI()][piece.getPos().getJ()]
            .pieceMap.requestLayout();
        this.container.addView(this.cells[piece.getPos().getI()][piece.getPos().getJ()].pieceMap);
        layoutParams = (RelativeLayout.LayoutParams)
            this.cells[piece.getPos().getI()][piece.getPos().getJ()].pieceMap.getLayoutParams();
